...
export const CONTACT = [
  { key: "address", value: "Address: 3rd floor, Clover Park, Viman Nagar, Pune" },
...
export const SOCIAL_MEDIA_LINKS = [
  {
    href: "https://x.com/",
    icon: <FaFacebook fontSize={30} className="hover:opacity-80 hover:text-blue-500" />,
  },

  {
    href: "https://x.com/",
    icon: <FaInstagram fontSize={30} className="hover:opacity-80 hover:text-pink-500" />,
  },
  {
    href: "https://x.com/",
